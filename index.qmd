...
Es una iniciativa ciudadana que nació de nuestra experiencia profesional con datos censales en el INDEC, motivada por la necesidad de contar con datos accesibles y ordenados, e inspirada en el espíritu colaborativo de la comunidad R. Con el apoyo del Programa de Campeones de rOpenSci (2023–2024), el proyecto es liderado por Andrea Gómez Vargas, junto a Emanuel Ciardullo como co-desarrollador.



![](images/SVG Brandpack/icon_lettering_black.svg){width="20%" fig-align="center"} 
...
- `census_metadata`:  Catálogo de tablas 

- `check_repository()`: Chequeo de tablas dispónibles por año , ubicación geográfica o temática

- `get_census()`: Obtener tablas

- `arcenso_app()`: tablero interactivo para consultas
...
> [Construyendo indicadores demográficos](https://soyandrea.github.io/arcenso/articles/indicadores_demograficos.html)
